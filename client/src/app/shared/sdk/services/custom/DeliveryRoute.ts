...
/**
 * Api services for the `DeliveryRoute` model.
 */
@Injectable()
export class DeliveryRouteApi extends BaseLoopBackApi {
  ...
  /**
   * Queries clients of DeliveryRoute.
   *
   * @param {any} id DeliveryRoute id
   *
   * @param {object} filter 
  ...
  /**
   * Counts clients of DeliveryRoute.
   *
   * @param {any} id DeliveryRoute id
   *
  ...
  public countClients(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DeliveryRoutes/:id/clients/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
